...
namespace Presentation {
    ...
    public partial class FerreteriaDataSet3 : global::System.Data.DataSet {
        ...
        public partial class productoDataTable : global::System.Data.TypedTableBase<productoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public productoRow AddproductoRow(string nombre, string categoria, string descripcion, decimal precio, decimal cantidad) {
...
namespace Presentation.FerreteriaDataSet3TableAdapters {
    ...
    public partial class productoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[producto] WHERE (([id] = @Original_id) AND ([nombre] = @Original_nombre) AND ([categoria] = @Original_categoria) AND ((@IsNull_descripcion = 1 AND [descripcion] IS NULL) OR ([descripcion] = @Original_descripcion)) AND ([precio] = @Original_precio) AND ([cantidad] = @Original_cantidad))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[producto] ([nombre], [categoria], [descripcion], [precio], [cantidad]) VALUES (@nombre, @categoria, @descripcion, @precio, @cantidad);
SELECT id, nombre, categoria, descripcion, precio, cantidad FROM producto WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[producto] SET [nombre] = @nombre, [categoria] = @categoria, [descripcion] = @descripcion, [precio] = @precio, [cantidad] = @cantidad WHERE (([id] = @Original_id) AND ([nombre] = @Original_nombre) AND ([categoria] = @Original_categoria) AND ((@IsNull_descripcion = 1 AND [descripcion] IS NULL) OR ([descripcion] = @Original_descripcion)) AND ([precio] = @Original_precio) AND ([cantidad] = @Original_cantidad));
SELECT id, nombre, categoria, descripcion, precio, cantidad FROM producto WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Presentation.Properties.Settings.Default.FerreteriaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nombre, categoria, descripcion, precio, cantidad FROM dbo.producto";
        ...
        public virtual int Fill(FerreteriaDataSet3.productoDataTable dataTable) {
        ...
        public virtual FerreteriaDataSet3.productoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FerreteriaDataSet3.productoDataTable dataTable = new FerreteriaDataSet3.productoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FerreteriaDataSet3.productoDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FerreteriaDataSet3 dataSet) {
        ...
        public virtual int Delete(int Original_id, string Original_nombre, string Original_categoria, string Original_descripcion, decimal Original_precio, decimal Original_cantidad) {
        ...
        public virtual int Insert(string nombre, string categoria, string descripcion, decimal precio, decimal cantidad) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, string categoria, string descripcion, decimal precio, decimal cantidad, int Original_id, string Original_nombre, string Original_categoria, string Original_descripcion, decimal Original_precio, decimal Original_cantidad, int id) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string categoria, string descripcion, decimal precio, decimal cantidad, int Original_id, string Original_nombre, string Original_categoria, string Original_descripcion, decimal Original_precio, decimal Original_cantidad) {
            return this.Update(nombre, categoria, descripcion, precio, cantidad, Original_id, Original_nombre, Original_categoria, Original_descripcion, Original_precio, Original_cantidad, Original_id);
        }
    }
