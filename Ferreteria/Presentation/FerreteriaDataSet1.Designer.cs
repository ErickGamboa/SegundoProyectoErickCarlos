...
namespace Presentation.FerreteriaDataSet1TableAdapters {
...
SELECT id, nombre, categoria, descripcion, precio, cantidad FROM producto WHERE (id = @id)";
        ...
        public virtual int Fill(FerreteriaDataSet1.productoDataTable dataTable) {
        ...
        public virtual FerreteriaDataSet1.productoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FerreteriaDataSet1.productoDataTable dataTable = new FerreteriaDataSet1.productoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FerreteriaDataSet1.productoDataTable dataTable) {
