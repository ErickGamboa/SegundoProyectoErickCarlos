...
namespace Data
{
    ...
    public partial class FerreteriaEntities : DbContext
    {
        ...
        public virtual int sp_ipedido_solo_servicio_constructor(string cedula_cliente, string codigo_usuario, string observaciones, Nullable<decimal> subtotal, Nullable<decimal> iva, Nullable<decimal> total)
        {
            var cedula_clienteParameter = cedula_cliente != null ?
                new ObjectParameter("cedula_cliente", cedula_cliente) :
                new ObjectParameter("cedula_cliente", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_ipedido_solo_servicio_constructor", cedula_clienteParameter, codigo_usuarioParameter, observacionesParameter, subtotalParameter, ivaParameter, totalParameter);
        }
        ...
        public virtual ObjectResult<sp_spedido_completo_obtener_productos_Result> sp_spedido_completo_obtener_productos(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_spedido_completo_obtener_productos_Result>("sp_spedido_completo_obtener_productos", idParameter);
        }
        ...
        public virtual int sp_upedido_cliente_factura(Nullable<int> id, Nullable<System.DateTime> fecha_factura, string codigo_cajero, Nullable<bool> paga_solo_producto)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
            ...
            var paga_solo_productoParameter = paga_solo_producto.HasValue ?
                new ObjectParameter("paga_solo_producto", paga_solo_producto) :
                new ObjectParameter("paga_solo_producto", typeof(bool));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_upedido_cliente_factura", idParameter, fecha_facturaParameter, codigo_cajeroParameter, paga_solo_productoParameter);
        }
        ...
        public virtual int sp_upedido_completo_factura(Nullable<int> id, Nullable<System.DateTime> fecha_factura, string codigo_cajero, Nullable<bool> paga_solo_producto)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_upedido_completo_factura", idParameter, fecha_facturaParameter, codigo_cajeroParameter, paga_solo_productoParameter);
        }
